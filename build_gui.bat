...
cl /nologo /std:c++17 /EHsc /MT /W3 /DUNICODE /D_UNICODE /I src /I third_party ^
   ...
   src\DisplayConfig.cpp src\Download.cpp src\Extract.cpp src\ExePatch.cpp src\ExePatchTable.cpp src\Installer.cpp ^
   src\NameHash.cpp src\NamelistData.cpp src\Sha256.cpp src\Unpacker.cpp src\Update.cpp src\VanillaManifest.cpp third_party\miniz.c build\gui.res ^
